...
<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        <!-- Navigation -->
        <nav
            class="sticky top-0 z-50 backdrop-blur-lg border-b border-gray-100 bg-white/80 dark:border-gray-800 dark:bg-gray-800/80"
        >
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        >
                            ...
                            />
                            <span
                                class="absolute -right-0 -top-0 flex h-4 w-4 items-center justify-center rounded-full bg-appGreenLight text-xs font-bold text-white"
                            >
                                2
                            </span>
                        </button>
                        ...
                        <div class="relative" ref="userMenuRef">
                            ...
                            >
                                ...
                                >
                                    <!-- User Info Header -->
                                    <div
                                        class="px-4 py-3 border-b border-gray-100 dark:border-gray-600"
                                    >
                                        <div
                                    ...
                                    <!-- Menu Groups -->
                                    <div
                                        v-for="(group, index) in userMenuItems"
                                        :key="index"
                                    >
                                        <!-- Quick Actions -->
                                        <div
                                            v-if="
                                                group.type === 'quick-actions'
                                            "
                                            class="px-2 py-2"
                                        >
                                            <Link
